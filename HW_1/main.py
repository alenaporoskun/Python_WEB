...
class PrintTable:
    @staticmethod
    def handle(address_book, text_title: str) -> None:
...
class UpcomingBirthdays:
    ...
    def handle(address_book: AddressBook) -> None:
        ...
        if upcoming_birthdays:
            ...
            PrintTable.handle(new_book, f'Upcoming birthdays within the next {days_count} days')
        else:
...
class ShowNotes:
    @staticmethod
    def handle(address_book: AddressBook, filename: str) -> None:
